...
//Function to sup Trackball's View
...
//Function to begin the trackball's motion
...
//function to stop motion of trackball
...
window.onload = function init() {
  ...
  document.getElementById("btnpause").onclick = function () {
    trackballMove = !trackballMove;
    changeIcon(this);
  };

  //slow speed event
  document.getElementById("speedslow").onclick = function () {
    angle = angle / 2;
  };

  //fast speed event
  document.getElementById("speedfast").onclick = function () {
    angle = angle * 2;
  };
  ...
  //Reset Trackball Button
  document.getElementById("btnreset").onclick = function () {
    window.location.reload();
  };

  // //Stop Trackball Button
